...
export default function Reservation() {
  ...
  return (
    <section id="reservation" className="py-20 bg-[url('https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?q=80&w=1974&auto=format&fit=crop')] bg-cover bg-center relative">
      <div className="absolute inset-0 bg-black/70"></div>
      <div className="relative max-w-4xl mx-auto px-4">
        <h2 className="text-4xl font-bold text-center mb-16 text-white">Make a Reservation</h2>
